...
public class MathUtil {
    ...
    /*
    static double trim(int degree, double d) {
        String format = "#.#";
    ...
    */
    ...
    /** Returns a long value into a readable time. */

    /** Returns all the values between start & end */
    ...
    /** Returns a shorten version of the specified numbers. */
    private static final NavigableMap<Long, String> suffixes = new TreeMap<>();

    static {
        suffixes.put(1_000_000L, "Mil");
        suffixes.put(1_000_000_000L, "Bil");
        suffixes.put(1_000_000_000_000L, "Tri");
        suffixes.put(1_000_000_000_000_000L, "Pil");
        suffixes.put(1_000_000_000_000_000_000L, "Eil");
    }
